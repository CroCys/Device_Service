...
public class RoomSpecification {
    ...
    public static Specification<Room> minSleepingPlaces(Integer minSleepingPlaces) {
        return (root, query, criteriaBuilder) ->
                minSleepingPlaces == null ? null : criteriaBuilder
                        .greaterThanOrEqualTo(root.get("sleepingPlaces"), minSleepingPlaces);
    }

    public static Specification<Room> maxSleepingPlaces(Integer maxSleepingPlaces) {
        return (root, query, criteriaBuilder) ->
                maxSleepingPlaces == null ? null : criteriaBuilder
                        .lessThanOrEqualTo(root.get("sleepingPlaces"), maxSleepingPlaces);
    }
